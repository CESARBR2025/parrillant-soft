...
import { Plus, Minus, ShoppingCart, X, ChevronRight, UtensilsCrossed } from 'lucide-react';
      ...
      <div className="flex-1 min-w-0 space-y-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            className="lg:hidden relative p-2 rounded-xl bg-card border border-border/60 text-muted hover:text-body"
          >
        ...
        {productosFiltrados.length === 0 ? (
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-3 pb-32 lg:pb-0">
            {productosFiltrados.map(producto => {
              ...
              return (
                <div
                  key={producto.id}
                  className="bg-card rounded-2xl border border-border/60 p-4 flex flex-col"
                >
                    ...
                    {qty > 0 ? (
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          ...
                          className="w-7 h-7 rounded-lg bg-accent text-white flex items-center justify-center hover:bg-accent-hover transition-colors"
                        >
                      ...
                      <button
                        onClick={() => addToCart(producto)}
                        className="rounded-lg bg-accent text-white px-3 py-1.5 text-xs font-medium hover:bg-accent-hover transition-colors"
                      >
                        Agregar
                      </button>
                    )}
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm">
          <div className="bg-card rounded-2xl border border-border/60 w-full max-w-lg shadow-2xl animate-in fade-in zoom-in-95 max-h-[90vh] flex flex-col">
            <div className="flex items-center justify-between px-6 pt-6 pb-0">
              <h2 className="text-lg font-semibold text-white">Confirmar pedido</h2>
              <button
            ...
            <div className="p-6 overflow-y-auto space-y-4">
              <div className="text-sm text-muted">
                Mesa <span className="text-white font-medium">{mesa.numero}</span>
                {mesa.zona && (
    ...
    <div className="bg-bg-base rounded-xl p-3">
      <div className="flex items-center justify-between gap-2">
        ...
        <div className="flex items-center gap-2 shrink-0">
          ...
          <span className="w-5 text-center text-sm font-medium text-white">{item.cantidad}</span>
          <button
            onClick={() => onIncrement(item.producto)}
            className="w-6 h-6 rounded-lg bg-accent text-white flex items-center justify-center hover:bg-accent-hover transition-colors"
          >
